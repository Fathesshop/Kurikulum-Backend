...
<div class="fixed-top">
  <div class="collapse" id="navbarToggleExternalContent" >
    <div class="bg-dark p-4">
      ...
      <span class="text-muted">Program class bangun datar (lingkaran, segitiga, dan persegi) dengan memanfaatkan autoloader dengan composer.</span>
    </div>
  </div>
...
<footer>
    ...
    <?php
        ...
        $persegi = new \ruang\persegi\persegi;
    ...
    <?php
        ...
        $segitiga = new \ruang\segitiga\segitiga;
        $alas = $_POST["alas"];
        $tinggi = $_POST["tinggi"];
